...
features_to_keep = ["left_eye_center_x","left_eye_center_y",
...
model.add(layers.Conv2D(32, (3, 3), activation='relu', use_bias=False, input_shape=(96, 96, 1)))
...
model.save('SimpleCnn'+str(N_EPOCHS)+'Epochs_BN.h5')
